...
public class ResultsTests
{
    ...
    public void Parse_CharArrayToDelegate_ThrowsException()
    {
        ...
        Assert.Throws<InvalidCastException>(() => Results.Parse<Action>(chars));
    ...
    public void Parse_CharArrayToUnsignedInt_ThrowsOverflow()
    {
        ...
        Assert.Throws<OverflowException>(() => Results.Parse<uint>(chars));
    ...
    public void Parse_InvalidCharArrayToBool_ThrowsFormatException()
    {
        ...
        Assert.Throws<FormatException>(() => Results.Parse<bool>(chars));
    ...
    {
        char[] chars = new[] { '{', 'a', '}' };
        Assert.Throws<InvalidCastException>(() => Results.Parse<CustomObject>(chars));
    ...
    public void Parse_LargeCharArrayToShort_ThrowsOverflow()
    {
        ...
        Assert.Throws<OverflowException>(() => Results.Parse<short>(chars));
    ...
    {
        char[] chars = new[] { 'a', 'b', 'c' };
        Assert.Throws<InvalidCastException>(() => Results.Parse<int?>(chars));
    ...
    public void Parse_CharArrayToStruct_ThrowsException()
    {
        ...
        Assert.Throws<InvalidCastException>(() => Results.Parse<CustomStruct>(chars));
    ...
    public void Parse_EmptyCharArrayToInt_ThrowsFormatException()
    {
        ...
        Assert.Throws<FormatException>(() => Results.Parse<int>(chars));
    ...
    {
        char[] chars = new[] { 'a', 'b', 'c' };
        Assert.Throws<InvalidCastException>(() => Results.Parse<Guid>(chars));
    ...
    //// 3. Type Safety - Demo problem
    //[Fact]
    //public void Parse_CharArrayToNonString_ThrowsInvalidCast()
    //{
    //    // Arrange: char[] should only safely cast to string
    //    char[] chars = new[] { '1', '2', '3' };

    //    // Act & Assert: Fails when casting to int
    //    var exception = Assert.Throws<InvalidCastException>(() =>
    //        Results.Parse<int>(chars));
    //    Assert.Contains("Unable to cast object", exception.Message);
    //    // Problem: char[] casting assumes T can accept string, fails for non-string types
    //}
    ...
    //[Fact]
    //public void Parse_CharArrayToInt_Fails()
    //{
    //    // Arrange
    //    char[] chars = new[] { '1', '2', '3' };
    ...
    //        Results.Parse<int>(chars)); // Should fail as it’s not a direct int
    //}
    ...
    //// Helper class for complex type test
    ...
    //{
    //    DateTime result = Convert.ToDateTime(new DateTime(2000, 1, 1, 1, 1, 1).ToString("yyyy-MM-ddTHH:mm:ss"));

    //    Assert.Equal(result, Results.Parse<DateTime>(result));
    //    Assert.Equal(result, Results.Parse<DateTime>(result.ToString("yyyy-MM-ddTHH:mm:ss")));
    //    Assert.Equal(result.ToString("yyyy-MM-ddTHH:mm:ss"), Results.Parse<string>(result));
    //}

    //[Fact]
    //public void CanParse_DateTimeOffset()
    //{
    //    DateTimeOffset result = Convert.ToDateTime(DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss.fff"));

    //    Assert.Equal(result, Results.Parse<DateTimeOffset>(result));
    //    Assert.Equal(result, Results.Parse<DateTimeOffset>(result.ToString("yyyy-MM-ddTHH:mm:ss.fff")));
    //    //Assert.Equal(result.ToString("yyyy-MM-ddTHH:mm:ss.fffzzz"), Results.Parse<string>(result));
    //}
    ...
    //    Assert.Equal(((int)result).ToString(), Results.Parse<string>(result));
    //}
    ...
    //    Assert.Equal(enum_value, Results.Parse<UserType>(value));
