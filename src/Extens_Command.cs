// Copyright (c) Oleksandr Viktor (UkrGuru) and Microsoft Copilot. All rights reserved.
...
/// <summary>
/// Provides helpers for creating SQL commands.
/// </summary>
public static partial class Extens
{
    /// <summary>
    /// Creates a SQL command with optional parameters and timeout.
    /// </summary>
