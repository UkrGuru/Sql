...
{
    public const string DbName = "WJaTests";
    ...
    public static string TestConnectionString
    {
        get
        {
            _connectionString ??= $"Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog={DbName};Integrated Security=True;Trust Server Certificate=True";
        ...
        get
        {
            if (_configuration == null)
            {
                var inMemorySettings = new Dictionary<string, string?>() {
                    ...
                    { "Logging:LogLevel:UkrGuru.WJb", "Debug" }
                };
